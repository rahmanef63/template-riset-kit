  ...
  return [
    ...
    // internal research workspace entities.
    {
      ...
      children: [
        ...
        { id: "about-principles", label: "About · Prinsip",  href: `${ADMIN_BASE}/about-principles`, icon: CheckCircle2, count: state.aboutPrinciples.length || null },
        { id: "about-timeline",   label: "About · Timeline", href: `${ADMIN_BASE}/about-timeline`,   icon: Milestone,    count: state.aboutTimeline.length || null },
